...
export default function TVShows() {
  ...
  const hasMore = selectedGenre ? genrePage < genreTotal : tvPage < tvTotalPages;
  ...
  const loadMore = useCallback(() => {
    if (selectedGenre) {
      ...
      if (!tvLoading && tvPage < tvTotalPages) dispatch(fetchTVPage(tvPage + 1));
    }
    ...
    <div className="min-h-screen bg-gray-950">
      <div className="max-w-7xl mx-auto pt-24 px-4 pb-16">
        <div className="mb-6">
          ...
          <p className="text-gray-400 text-sm mt-1">{displayList.length} shows loaded</p>
        </div>
